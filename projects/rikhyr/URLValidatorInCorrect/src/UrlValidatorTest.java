...
public class UrlValidatorTest extends TestCase {
   ...
   System.out.println("=======================================================");	 
	System.out.println("Running Programming Based Unit Tests...");	   
	System.out.println("-------------------------------------------------------");
   ...
   String[] mainvalidschemes = {"bittorrent://","callto://","callto:","feed://","file://","ftp://","gopher://","http://","https://","h3t://","LDAP://","magnet://","mailto://","mailto:","MMS://","mql5buy://","res://","skype://","tel://","viber://"};
	   ...
	   for(int j= 0;j<basic_urls.length;j++)
	   {
         ...
         if (urlVal.isValid(loc_url+"/"+basic_anchor)!=true)
        	 {
        	 System.out.println("Test failed");
        	 num_failed_tests++;
        	 };
         ...
         if (urlVal.isValid(loc_url+basic_anchor)!=false)
        	 {
        	 System.out.println("Test failed");
        	 num_failed_tests++;
        	 };
         ...
         if (urlVal.isValid(loc_url+"/"+basic_uri)!=true)
        	 {
        	 System.out.println("Test failed");
        	 num_failed_tests++;
        	 };
         ...
         if (urlVal.isValid(loc_url+"/"+basic_uri+basic_anchor)!=true)
        	 {
        	 System.out.println("Test failed");
        	 num_failed_tests++;
        	 };
         ...
         if (urlVal.isValid(loc_url+"/"+basic_uri+"#"+basic_anchor)!=false)
        	 {
        	 System.out.println("Test failed");
        	 num_failed_tests++;
        	 }; //multiple sequential "#" are not allowed
		 
		 System.out.println("Testing correct protocol and incorrect URI handling: "+loc_url+"/ "+basic_uri);
         if (urlVal.isValid(loc_url+"/ "+basic_uri)!=false)
        	 {
        	 System.out.println("Test failed");
        	 num_failed_tests++;
        	 };
         ...
         if (urlVal.isValid(loc_url+"/"+basic_anchor+basic_anchor)!=false)
        	 {
        	 System.out.println("Test failed");
        	 num_failed_tests++;
        	 };
         ...
         if (urlVal.isValid(loc_url+"/"+basic_uri+basic_anchor+"?"+basic_uri)!=false)
        	 {
        	 System.out.println("Test failed");
        	 num_failed_tests++;
        	 };
         ...
         if (urlVal.isValid(loc_url+"/"+basic_uri+"//"+basic_uri)!=true)
        	 {
        	 System.out.println("Test failed");
        	 num_failed_tests++;
        	 };
         ...
         if (urlVal.isValid(loc_url+"/"+basic_uri+"/"+basic_uri+basic_anchor)!=true)
        	 {
        	 System.out.println("Test failed");
        	 num_failed_tests++;
        	 };
         ...
         if (urlVal.isValid(loc_url+"/"+basic_uri+"?a="+basic_anchor)!=false)
        	 {
        	 System.out.println("Test failed");
        	 num_failed_tests++;
        	 };
         ...
         if (urlVal.isValid(loc_url+"/"+basic_uri+basic_anchor+"/a")!=false)
        	 {
        	 System.out.println("Test failed");
        	 num_failed_tests++;
        	 };
	   ...
	   System.out.println("-------------------------------------------------------");
		System.out.println("Programmed Unit Tests Complete.  Out of the 11000 tests run, " + num_failed_tests + " tests failed.");
		System.out.println("=======================================================\n\n");
   } //testIsValid method
