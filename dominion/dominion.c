...
int my_smithy (int currentPlayer,struct gameState *state, handpos)
{
int i;
...
int my_council_room(int currentPlayer, struct gameState *state);
{
int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case council_room:
	 ...
	 return my_council_room(currentPlayer, state);
